...
class bugs(Task):
    ...
    def make(self):
        webbrowser.open("http://github.com/trentm/sources/issues")

class site(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://github.com/trentm/sources")

class pypi(Task):
    """open project page"""
    def make(self):
        webbrowser.open("http://pypi.python.org/pypi/sources/")
...
class cut_a_release(Task):
    ...
    """
    proj_name = "sources"
    version_py_path = "lib/sources.py"
    version_module = "sources"
